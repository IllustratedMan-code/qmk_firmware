...
#define ESCCTRL MT(MOD_LCTL, KC_ESC)
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    KC_GRV,  _______, KC_LEFT, KC_DOWN, KC_RIGHT, KC_LPRN, KC_RPRN, KC_4,    KC_5,    KC_6,   KC_PLUS, _______,
...
[_ADJUST] = LAYOUT_planck_grid(
    QK_BOOT, DB_TOGG, AU_TOGG, CK_TOGG, UG_TOGG, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
)
...
layer_state_t layer_state_set_user(layer_state_t state) {
  ...
  switch(get_highest_layer(state)) {
	...
	if (rgblight_config.enable) {
		    rgblight_sethsv_noeeprom(RGB_BLACK);
